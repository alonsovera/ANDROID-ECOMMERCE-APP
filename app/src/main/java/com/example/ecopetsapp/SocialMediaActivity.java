...
public class SocialMediaActivity  extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void ActivityLocation() {
        Toast.makeText(this,"Loaction", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(SocialMediaActivity.this, LocalizarActivity.class);
    ...
    private void ActivityAboutUs() {
        ...
        Intent intent = new Intent(SocialMediaActivity.this, AboutUsActivity.class);
        startActivity(intent);
    }
    ...
    private void ActivityCarrito() {
        ...
        Intent intent = new Intent(SocialMediaActivity.this, CarritoActivity.class);
        startActivity(intent);
    }
    private void ActivityBuscar() {
        Toast.makeText(this,"Products", Toast.LENGTH_SHORT).show();

        Intent intent = new Intent(SocialMediaActivity.this, PrincipalActivity.class);
        startActivity(intent);
    }
    ...
    private void ActivityHelp() {
        ...
        Intent intent = new Intent(SocialMediaActivity.this, ActivityHelp.class);
        startActivity(intent);
    }
