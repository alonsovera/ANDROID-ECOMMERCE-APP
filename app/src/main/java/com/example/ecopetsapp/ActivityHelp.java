...
public class ActivityHelp extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void ActivityLocation() {
        ...
        Intent intent = new Intent(ActivityHelp.this, LocalizarActivity.class);
    ...
    private void ActivityAboutUs() {
        ...
        Intent intent = new Intent(ActivityHelp.this, AboutUsActivity.class);
        startActivity(intent);
    }
    ...
    private void ActivityCarrito() {
        ...
        Intent intent = new Intent(ActivityHelp.this, CarritoActivity.class);
        startActivity(intent);
    }
    private void ActivityBuscar() {
        Toast.makeText(this,"Products", Toast.LENGTH_SHORT).show();

        Intent intent = new Intent(ActivityHelp.this, PrincipalActivity.class);
        startActivity(intent);
    }
    private void ActivitySocialMedia() {
        Toast.makeText(this,"Social Media", Toast.LENGTH_SHORT).show();

        Intent intent = new Intent(ActivityHelp.this, SocialMediaActivity.class);
        startActivity(intent);
    }
    private void ActivityHelp() {
        Toast.makeText(this,"Help", Toast.LENGTH_SHORT).show();

        Intent intent = new Intent(ActivityHelp.this, ActivityHelp.class);
        startActivity(intent);
    }
